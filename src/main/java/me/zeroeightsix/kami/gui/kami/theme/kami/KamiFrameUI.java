...
extends AbstractComponentUI<Frame> {
    ...
    public void renderComponent(Frame component, FontRenderer fontRenderer) {
        ...
        GL11.glColor4f((float)colorBack.getBRed().floatValue(), (float)colorBack.getBGreen().floatValue(), (float)colorBack.getBBlue().floatValue(), (float)colorBack.getBAlpha().floatValue());
        RenderHelper.drawFilledRectangle(0.0f, 0.0f, component.getWidth(), component.getHeight());
        GL11.glColor3f((float)colorBack.getORed().floatValue(), (float)colorBack.getOGreen().floatValue(), (float)colorBack.getOBlue().floatValue());
        GL11.glLineWidth((float)1.5f);
        RenderHelper.drawRectangle(0.0f, 0.0f, component.getWidth(), component.getHeight());
        GL11.glColor3f((float)1.0f, (float)1.0f, (float)1.0f);
        ff.drawString(8, 2, component.getTitle());
        int top_y = 5;
        ...
        if (component.isMinimizeable()) {
            if (component.isMinimized()) {
                ...
                GL11.glBegin((int)1);
                GL11.glVertex2d((double)(component.getWidth() - 11), (double)3.0);
                GL11.glVertex2d((double)(component.getWidth() - 8), (double)6.0);
                GL11.glEnd();
                GL11.glBegin((int)1);
                GL11.glVertex2d((double)(component.getWidth() - 8), (double)6.0);
                GL11.glVertex2d((double)(component.getWidth() - 5), (double)3.0);
                GL11.glEnd();
            } else {
                GL11.glLineWidth((float)0.5f);
                GL11.glBegin((int)1);
                GL11.glVertex2d((double)(component.getWidth() - 5), (double)6.0);
                GL11.glVertex2d((double)(component.getWidth() - 8), (double)3.0);
                GL11.glEnd();
                GL11.glBegin((int)1);
                GL11.glVertex2d((double)(component.getWidth() - 8), (double)3.0);
                GL11.glVertex2d((double)(component.getWidth() - 11), (double)6.0);
                GL11.glEnd();
            }
        }
        if (component.isPinneable()) {
            ...
            RenderHelper.drawCircle(component.getWidth() - 20, 4.0f, 2.0f);
            GL11.glLineWidth((float)3.0f);
            GL11.glBegin((int)1);
            GL11.glVertex2d((double)(component.getWidth() - 20), (double)4.0);
            GL11.glVertex2d((double)(component.getWidth() - 17), (double)8.0);
            GL11.glEnd();
        }
        if (!component.isMinimized()) {
            GL11.glColor3f((float)0.32f, (float)0.32f, (float)0.32f);
            GL11.glLineWidth((float)0.5f);
            GL11.glBegin((int)1);
            GL11.glVertex2d((double)1.0, (double)10.0);
            GL11.glVertex2d((double)(component.getWidth() - 1), (double)10.0);
            GL11.glEnd();
        }
